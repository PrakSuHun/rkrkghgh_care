  ...
  return (
    <div className="px-4 py-4 sm:p-6 max-w-3xl mx-auto space-y-4">
      ...
      <RecordingDialog
        ...
        title={`초기상담 녹음${seniorName ? ` · ${seniorName}` : ""}`}
        ...
        guide={
          <div className="space-y-1.5">
            <p className="font-semibold text-amber-900">녹음 가이드 — 보면서 말해주세요</p>
            <p>기억나는 것만 말씀하셔도 됩니다. 자연스러운 순서로 천천히.</p>
            <p><b>1) 기본 정보</b> — 이름·성별·생년월일·등급·고향·학력·종교·경제상태·키/체중·배우자</p>
            <p><b>2) 보호자</b> — 이름·관계·연락처·자녀수·동거(왕래) 여부</p>
            <p><b>3) 일상생활</b> — 보행·식사·용변(자립/도움/완전도움)·정서·개인성향·습관</p>
            <p><b>4) 영양</b> — 치아·배변·식사 형태(일반식/다짐찬/유동식/경관식)</p>
            <p><b>5) 회화</b> — 시력·청력(이명·보청기)·말하기</p>
            <p><b>6) 병력·질환</b> — 발병시기·주 의료기관·주요 질환·복용약</p>
            <p><b>7) 종합</b> — 개별욕구·상담자 의견</p>
            <p className="mt-2 pt-2 border-t border-amber-200 text-gray-600">
              예시: "전대순 어르신, 여성, 1935년 10월 15일생. 4등급. 경제상태 일반. 배우자 없음. 보호자 큰아들 이현수 010-8475-3336. 자녀 2남1녀, 주 1~2회 왕래. 보행 도움·식사 자립. 정서 조금 불안. 고혈압·당뇨. 2025년 7월 담석 수술, 성모병원. 복용약은 당뇨·고혈압·퇴행성이명…"
            </p>
          </div>
        }
      />
